...
$teacherId = $_GET['id']; // Assuming you're passing the teacher ID in the URL
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <!-- Status Display -->
                        <span class="badge 
                            <?= $teacher['status'] === 'Active' ? 'badge-success' : ($teacher['status'] === 'Inactive' ? 'badge-danger' : 'badge-warning'); ?>">
                    ...
                    <td>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-light dropdown-toggle" type="button" id="maintenanceDropdown<?= $teacher['id']; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="material-icons">settings</i>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="maintenanceDropdown<?= $teacher['id']; ?>">
                                <form action="update_status.php" method="post" style="display:inline;">
                                    <input type="hidden" name="id" value="<?= htmlspecialchars($teacher['id']); ?>">
                                    <button type="submit" name="status" value="Active" class="dropdown-item <?= $teacher['status'] === 'Active' ? 'active' : ''; ?>">Active</button>
                                    <button type="submit" name="status" value="Inactive" class="dropdown-item <?= $teacher['status'] === 'Inactive' ? 'active' : ''; ?>">Inactive</button>
                                    <button type="submit" name="status" value="On Leave" class="dropdown-item <?= $teacher['status'] === 'On Leave' ? 'active' : ''; ?>">On Leave</button>
                                </form>
                            </div>
                        </div>
                    </td>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="dropdown">
                                    <input type="text" id="subjectInput" class="form-control" name="Tsubject"
                                        value="<?php echo htmlspecialchars($teacher['Tsubject']); ?>"
                                        autocomplete="off" placeholder="Select or type a subject..." required>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="gradelevel" required>
                                    ...
                                    <option>Fouzrth Year College</option>
